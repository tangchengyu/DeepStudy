...
handleSyncIpc("sync:conflict-status", (_event, conflictId, expected) => desktopSyncService.conflictStatus(conflictId, expected));
handleSyncIpc("sync:conflict-reconcile", (_event, input, expected) => desktopSyncService.reconcileConflict(input, expected));

(() => {
  ...
  const zhSteps = [
    ...
    },
    {
      target: "#long-tasks-open",
      title: "长期任务的操作方式",
      description: "长期任务左侧色块是拖拽控制区，可在象限之间移动或调整同象限顺序；点击任务卡片其他区域会进入详情编辑。右键菜单包含“复制到今日任务”和“删除”。详情页可直接编辑任务名称、提醒方式和提醒时间；Markdown 备注支持直接粘贴图片，也支持 ![[C:\\本地路径\\图片.png]]，导入后会保存在本机。",
      view: "gate",
    },
    {

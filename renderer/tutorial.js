(() => {
  ...
  const steps = [
    {
      target: "#top-bar",
      title: "欢迎来到 DeepStudy",
      description: "这是一段可随时退出的交互式教程。我们会依次认识计划、专注、恢复和复盘工具；教程不会替你修改任务，也不会启动计时。",
      view: "gate",
    },
    {
      target: "#daily-plan-sidebar",
      title: "先把今天变得清晰",
      description: "在每日计划中输入任务并按回车添加，勾选即可完成。优先任务、重置和清除已完成操作都集中在这里。",
      view: "gate",
    },
    {
      target: "#chat-toggle",
    ...
    },
    {
      ...
      title: "管理长期任务",
      description: "长期任务使用重要/紧急四象限整理目标，并可把下一步拖入今日计划，适合承接跨天项目。",
      view: "gate",
    },
    {
      target: "#soul-open",

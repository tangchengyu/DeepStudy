(() => {
  ...
  const steps = [
    ...
    },
    {
      ...
      title: "先把今天变得清晰",
      description: "在每日计划中输入任务并按回车添加，勾选即可完成。完成记录会自动进入“长期习惯构建”的每日反思；误触勾选后会出现 10 秒撤回按钮。右键今日任务可加入或取消优先任务。",
      view: "gate",
    },
    {
      target: "#chat-toggle",
    ...
    },
    {
      target: "#long-tasks-open",
      title: "长期任务的操作方式",
      description: "长期任务右键菜单包含“复制到今日任务”和“删除”。进入某个长期任务详情后，可以直接像记事本一样编辑任务名称和 Markdown 备注，系统会自动保存，因此不再需要右键编辑。",
      view: "gate",
    },
    {
      target: "#soul-open",
